...
// SupportBoi is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterBoi.
contract SupportBoi {
    ...
    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many DOGGYPOUND tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws DOGGYPOUND tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes doggyPound tokens.
    ...
    // Deposit doggyPound tokens to SupportBoi for Reward allocation.
    ...
    // Withdraw doggyPound tokens from SupportBoi.
