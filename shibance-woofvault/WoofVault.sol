...
// File: contracts/WoofVault.sol

pragma solidity 0.6.12;

contract WoofVault is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 cakeAtLastUserAction; // keeps track of WOOF deposited at the last user action
    ...
    /**
     * @notice Constructor
     * @param _token: WOOF token contract
     * @param _receiptToken: DOGGYPOUND token contract
     * @param _masterchef: MasterBoi contract
    ...
    /**
     * @notice Deposits funds into the WOOF Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in WOOF)
     */
    ...
    /**
     * @notice Reinvests WOOF tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the WOOF Vault
     */
     ...
     * @return Expected reward to collect in WOOF
     */
     ...
     * @return Returns total pending WOOF rewards
     */
    ...
    /**
     * @notice Withdraws from funds from the WOOF Vault
